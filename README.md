...
* <!--RPythonExp-->14.9<!--END--> years in R/Python
* <!--HealthAnalysis-->7.5<!--END--> years in health data analysis/science
* <!--SurgDesign-->6.9<!--END--> years in surgical study design and biostatistics
* <!--AusHC-->11<!--END--> years experience in the Australian healthcare system
...
| To Do | Doing | Done |
| --- | --- | --- |
| Publication: Data governance publication - data analysis | Personal: Project Euler: 100 | Personal: Project Euler: 74, 97 & 99 |
| modulartabler: Implement linked table suppression | escapeRoom: Add tests | University: Prepare S1 unit |
| escapeRoom: Improve win/fail notifications |   |   |
| Personal: Build murder mystery group challenge |   |   |
| Personal: Code Poker team game |   |   |

*Last updated: 2025-02-16 22:28 AEDT*
<!--END-->
